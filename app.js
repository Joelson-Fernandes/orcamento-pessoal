...
class Bd{
    ...
    recuperarTodosRegistros(){
        ...
        for(let i = 1; i <= id; i++){
            ...
            //neste casso ira pular esses indices 
            if(despesa === null){
                continue
            }
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    despesas.forEach(function(d){
        ...
        btn.onclick = function() {
            ...
            document.getElementById('modal_titulo').innerHTML = 'Registro escluido'
            document.getElementById('modal-body').innerHTML = 'Despesa foi excluida com sucesso!'
            document.getElementById('modal_titulo_div').className = 'modal-header text-success'
            document.getElementById('botao_modal').className = 'btn btn-success'
            document.getElementById('botao_modal').innerHTML = 'Voltar'
            $('#modalRegistraDespesa').modal({backdrop: 'static', keyboard: false})  
            $('#modalRegistraDespesa').modal('show')
            document.getElementById('botao_modal').onclick = function(){window.location.reload()}
        }
